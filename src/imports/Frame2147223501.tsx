import svgPaths from "./svg-qrxl3wupqq";
import imgImage3 from "figma:asset/7538dd53e39ed501d6f3a6772a683ae79d39c9d0.png";
...
function BackgroundImage13({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative w-full">
      <div className="content-stretch flex flex-col items-start px-[16px] relative size-full">{children}</div>
    </div>
  );
}
...
function BackgroundImage5() {
  return <BackgroundImage7>{`Terms & Conditions`}</BackgroundImage7>;
}

function BackgroundImage4() {
  return <BackgroundImage7>{`Help & Support`}</BackgroundImage7>;
}

function BeSafeOnlineBackgroundImage() {
  return (
    <div className="bg-white content-stretch flex items-center relative shrink-0 w-[268px]">
      <BackgroundImageAndText2 text="Be Safe Online" />
      <IconsNavigateNext24PxBackgroundImage />
    </div>
  );
}
...
function AdobeAfterEffectBackgroundImage() {
  return (
    <BackgroundImage10>
...
function BackgroundImage1() {
  return (
    <BackgroundImage8>
      ...
      <BackgroundImage11>{`Privacy & Settings`}</BackgroundImage11>
    </BackgroundImage8>
  );
}

function MyPartnerPreferenceBackgroundImage() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[268px]">
      ...
      <BackgroundImage8>
        ...
        <BackgroundImage11>{`Partner Preferences `}</BackgroundImage11>
      </BackgroundImage8>
      <IconsNavigateNext24PxBackgroundImage />
    </div>
  );
...
function BackgroundImageAndText({ text }: BackgroundImageAndTextProps) {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
      ...
      <div className="bg-[#cff6e4] content-stretch flex items-center p-[6px] relative rounded-[24px] shrink-0">
...
function Crown03SolidRoundedBackgroundImage() {
  return (
    <BackgroundImage12>
...
function IconsNavigateNext24PxBackgroundImage() {
  return (
...
export default function Frame() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-white bottom-0 content-stretch flex flex-col gap-[16px] h-[800px] items-start left-[374px] overflow-clip pt-[32px] w-[300px]" data-name="option 3">
        <div className="content-stretch flex flex-col gap-[24px] items-start pt-[16px] relative shrink-0 w-full">
          <div className="content-stretch flex gap-[12px] items-center px-[16px] relative shrink-0 w-[300px]">
            <div className="relative shrink-0 size-[64px]">
              <div className="absolute bg-[#f6f6f6] left-0 overflow-clip rounded-[25806.453px] size-[64px] top-0" data-name="Male">
                <div className="absolute left-0 size-[64px] top-0">
                  <div className="absolute bg-[#f6f6f6] left-0 overflow-clip rounded-[25806.453px] size-[64px] top-0" data-name="Male">
                    <div className="-translate-x-1/2 absolute h-[66.413px] left-[calc(50%-0.23px)] top-[9.24px] w-[58.776px]">
                      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 58.7762 66.4131">
                        <g id="Frame 1707479729">
                          <path d={svgPaths.p36d49bf0} fill="url(#paint0_radial_10125_1919)" id="Ellipse 8696" />
                          <path d={svgPaths.p1c855140} fill="var(--fill-0, #D1D1D1)" id="Vector 2" />
                          <path d={svgPaths.p16f3db00} fill="url(#paint1_linear_10125_1919)" id="Ellipse 8697" />
                          <path d={svgPaths.p2a71b380} fill="var(--fill-0, #7B7B7B)" id="Vector 3" />
                          <ellipse cx="42.173" cy="18.7618" fill="var(--fill-0, #D1D1D1)" id="Ellipse 8698" rx="1.99239" ry="2.82256" />
                          <ellipse cx="16.6035" cy="18.7618" fill="var(--fill-0, #D1D1D1)" id="Ellipse 8699" rx="1.99239" ry="2.82256" />
                        </g>
                        <defs>
                          <radialGradient cx="0" cy="0" gradientTransform="translate(29.2589 38.7555) rotate(90) scale(13.3333 22.4762)" gradientUnits="userSpaceOnUse" id="paint0_radial_10125_1919" r="1">
                            <stop stopColor="#939393" />
                            <stop offset="1" stopColor="#AEAEAE" />
                          </radialGradient>
                          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_10125_1919" x1="29.2583" x2="29.3873" y1="14.7559" y2="32.2244">
                    ...
                    <div className="absolute left-[-2.13px] size-[68.978px] top-[-2.84px]" data-name="image 3">
                      <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        <img alt="" className="absolute h-[1159.42%] left-[-30.43%] max-w-none top-[-123.19%] w-[535.71%]" src={imgImage3} />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative shrink-0 w-[300px]">
            <div className="flex flex-col justify-center size-full">
              <div className="content-stretch flex flex-col items-start justify-center px-[8px] relative w-full">
                <div className="relative rounded-[12px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(104.684deg, rgb(255, 255, 255) 2.8292%, rgb(255, 246, 246) 97.171%)" }}>
                  <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                    <div className="content-stretch flex gap-[4px] items-center pl-[10px] pr-[8px] py-[8px] relative w-full">
                      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                        <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[#41404d] text-[16px] w-[140px] whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
                          Gold Plus Member
                        </p>
                        <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
                          ...
                          <div className="bg-[#cff6e4] relative rounded-[20px] shrink-0" data-name="Hobbies & Interest Chips">
                            <div aria-hidden="true" className="absolute border border-[#cff6e4] border-solid inset-0 pointer-events-none rounded-[20px]" />
                            <div className="flex flex-row items-center size-full">
                              <div className="content-stretch flex gap-[4px] items-center pb-[3px] pt-[2px] px-[8px] relative">
                                <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#009f46] text-[12px] tracking-[0.2px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                                  Active
                                </p>
                              </div>
                      ...
                      <IconsNavigateNext24PxBackgroundImage />
                      <div className="absolute flex items-center justify-center left-[182.26px] size-[72.561px] top-[2.16px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18" } as React.CSSProperties}>
                        <div className="flex-none rotate-[-17.92deg]">
                          <div className="relative size-[57.625px]" data-name="crown-03-solid-rounded (1) 2">
                            <div className="absolute inset-[0_0_-1.8%_0]">
                              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 57.6255 58.6609">
                                <g id="crown-03-solid-rounded (1) 2" opacity="0.05">
                                  <path clipRule="evenodd" d={svgPaths.p967ff00} fill="var(--fill-0, #FF5A60)" fillRule="evenodd" id="Vector" />
                                  <path d={svgPaths.p27713000} fill="var(--fill-0, #FF5A60)" id="Vector_2" />
                                </g>
                              </svg>
                            </div>
                          </div>
        ...
        <BackgroundImage13>
          <div className="content-stretch flex items-center relative shrink-0 w-[268px]" data-name="Get Premium">
            ...
            <BackgroundImage9>
              <div className="bg-gradient-to-r content-stretch flex from-[#ff5a60] items-center justify-center p-[5.6px] relative rounded-[14.769px] shrink-0 size-[24px] to-[#f93961]" data-name="Premium Tag New">
                <Crown03SolidRoundedBackgroundImage />
              </div>
              <BackgroundImageAndText text="Renew Premium" />
            </BackgroundImage9>
            <IconsNavigateNext24PxBackgroundImage />
          </div>
          <MyPartnerPreferenceBackgroundImage />
          ...
          <div className="content-stretch flex items-center relative shrink-0 w-[268px]" data-name="AstroChat">
            <BackgroundImage9>
              <AdobeAfterEffectBackgroundImage />
              <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
                <BackgroundImageAndText1 text="AstroChat" />
              </div>
            </BackgroundImage9>
            <IconsNavigateNext24PxBackgroundImage />
          </div>
            ...
            <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="hygiene list">
              <div className="content-stretch flex flex-col items-start relative shrink-0">
                ...
                <div className="bg-white content-stretch flex items-center relative shrink-0 w-[268px]" data-name="Rate the App">
                  <BackgroundImageAndText2 text="Rate the App" />
                  <IconsNavigateNext24PxBackgroundImage />
                </div>
                <div className="bg-white content-stretch flex items-center relative shrink-0 w-[268px]" data-name="Rate the App">
                  <BackgroundImage5 />
      ...
      <div className="absolute bg-white bottom-0 content-stretch flex flex-col gap-[16px] h-[800px] items-start left-0 overflow-clip pt-[32px] w-[300px]" data-name="option 2">
        <div className="content-stretch flex flex-col gap-[24px] items-start pt-[16px] relative shrink-0 w-full">
          <div className="content-stretch flex gap-[12px] items-center px-[16px] relative shrink-0 w-[300px]">
        ...
        <BackgroundImage13>
          <div className="content-stretch flex items-center relative shrink-0 w-[268px]" data-name="Get Premium">
            ...
            <BackgroundImage9>
              ...
              <BackgroundImageAndText text="Get Premium" />
            </BackgroundImage9>
            <IconsNavigateNext24PxBackgroundImage />
          </div>
          <div className="content-stretch flex items-center relative shrink-0 w-[268px]" data-name="Complete Verification">
            <BackgroundImage8>
              ...
              <BackgroundImageAndText1 text="Complete Verification" />
