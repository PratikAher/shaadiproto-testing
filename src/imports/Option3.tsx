import svgPaths from "./svg-ip5bmvr1mj";
...
export default function Option() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] items-start pt-[32px] relative size-full" data-name="option 3">
        ...
        <div className="content-stretch flex flex-col items-start px-[16px] relative size-full">
          ...
          <div className="content-stretch flex items-center relative shrink-0 w-[268px]" data-name="My Partner Preference">
            ...
            <BackgroundImage2>
              ...
              <BackgroundImage3>{`Partner Preferences `}</BackgroundImage3>
            </BackgroundImage2>
            <IconsNavigateNext24PxBackgroundImage />
          </div>
          <div className="content-stretch flex items-center relative shrink-0 w-[268px]" data-name="Settings & Privacy">
            <BackgroundImage2>
              ...
              <BackgroundImage3>{`Privacy & Settings`}</BackgroundImage3>
            </BackgroundImage2>
            <IconsNavigateNext24PxBackgroundImage />
          </div>
          ...
          <div className="content-stretch flex items-center relative shrink-0 w-[268px]" data-name="AstroChat">
            <BackgroundImage1>
              ...
              <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
                <BackgroundImageAndText text="AstroChat" />
              </div>
            </BackgroundImage1>
            <IconsNavigateNext24PxBackgroundImage />
          </div>
